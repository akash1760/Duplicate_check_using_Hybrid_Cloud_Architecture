            ...
            <div id="site_content" style="width:1484px;margin-left: -280px;height:450px;margin-top: -5px">
                ...
                <div id="content">
                    <fieldset class="fset" style="width:1000px;background-color: wheat;margin-top: 50px;height:395px;box-shadow:0 1px 4px rgba(0, 0, 0, 0.3), 0 0 40px rgba(0, 0, 0, 0.1) inset">
                        <center>
                            <h1 style="font-family:optima">Admin Login</h1><br/>
                            <!--<form action="admin_login" name="ulogin" method="post" onsubmit="return validation()">-->
                            <form action="admin_page.jsp" name="ulogin" method="post" onsubmit="return validation()"> 
                    ...
                    background: radial-gradient(118.29% 283.09% at 106.71% 0%,#3f1e9d 0%,#000000 100%);
...
/*            #id{
            ...
            <footer style="width: 1482px;margin-left: -280px;height:50px">
                <p>&copy;</p>
            </footer>
        </div>
        <p>&nbsp;</p>
